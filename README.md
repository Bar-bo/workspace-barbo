...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSvg2gcodeWidget</td><td>function</td><td>function (callback) <br><br>Load the svg2gcode List via chilipeppr.load() so folks have a sample
