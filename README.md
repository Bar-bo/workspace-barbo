...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadEagleWidget</td><td>function</td><td>function (callback) com-chilipeppr-widget-eagle<br><br>Load the eagle List via chilipeppr.load() so folks have a sample
