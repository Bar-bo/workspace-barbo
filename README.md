...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadWcsWidget</td><td>function</td><td>function (callback) <br><br>Load thewcs List via chilipeppr.load() so folks have a sample
